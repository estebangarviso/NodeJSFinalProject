 ...
 */
export const saveRole: (role: IRole) => Promise<HydratedDocument<IRole>> = async (role) => {
 ...
 */
export const getRoleByID: (id: string) => Promise<HydratedDocument<IRole>> = async (id) => {
 ...
 * @returns { Promise<HydratedDocument<IRole>> } The first role in the array of roles.
 */
export const getRoleByName: (name: string) => Promise<HydratedDocument<IRole>> = async (name) => {
